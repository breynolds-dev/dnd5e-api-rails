...
Skill.create(
  name: 'History',
  ability: 'Intelligence',
  description: 'Your Intelligence (History) check mseasures your ability to recall lore about historical events, legendary people, ancient kingdom s, past disputes, recent wars, and lost civilizations.'
)
...
Skill.create(
  name: 'Medicine',
  ability: 'Wisdom',
  description: 'A Wisdom (Medicine) check lets you try to stabilize a dying com panion or diagnose an illness.'
)
...
Skill.create(
  name: 'Religion',
  ability: 'Intelligence',
  description: 'Your Intelligence (Religion) check measures your ability to recall lore about deities, rites and prayers, religious hierarchies, holy symbols, and the practice of secret cults.'
)
